...
To create a SeedStack project from scratch you can use `generate-project` goal from the SeedStack Maven Plugin.
...
<table class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        not specified explicitly. No default value. Available types are: web, domain, batch and function.</td>
    </tr>
    <tr>
...
Interactive mode:
    ...
    mvn org.seedstack:seedstack-maven-plugin:generate-project

Batch mode:

    mvn org.seedstack:seedstack-maven-plugin:generate-project -DgroupId=org.myorganization -DartifactId=myproject -Dtype=web
